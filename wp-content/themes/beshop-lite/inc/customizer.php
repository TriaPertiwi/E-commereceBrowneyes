...
function beshop_freecustomize_register($wp_customize)
{
    ...
    $wp_customize->add_control('beshopfree_blog_style', array(
        'label'      => __('Select Blog Style', 'beshop-lite'),
        'section'    => 'beshop_blog',
        'settings'   => 'beshopfree_blog_style',
        'type'       => 'select',
        'choices'    => array(
            'style1' => __('List over Image', 'beshop-lite'),
            'style2' => __('List Style', 'beshop-lite'),
            'style3' => __('Classic Style', 'beshop-lite'),
            'style4' => __('Grid Style', 'beshop-lite'),
        ),
    ));
    ...
    $wp_customize->add_control('beshop_shop_style', array(
        'label'      => __('Select Products Style', 'beshop-lite'),
        'section'    => 'beshop_shop',
        'settings'   => 'beshop_shop_style',
        'type'       => 'select',
        'choices'    => array(
            '1' => __('Style One', 'beshop-lite'),
            '2' => __('Style Two', 'beshop-lite'),
        ),
    ));
}
